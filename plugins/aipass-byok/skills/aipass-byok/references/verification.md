...
After reporting the core integration, offer only text-AI follow-ups that directly solve a visible product need. Do not expand into image, audio, or video generation under this skill.
